  ...
  return (
    ...
    <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
      ...
      <div className="mt-5 max-w-3xl text-center mx-auto">
        <p className="text-lg text-secondary-foreground dark:text-secondary-foreground">
          InnoGen is a modern, fast and ai powered image manipulation and
          generation tool. It is a perfect tool for designers, developers and
          anyone who needs to a quick image resoultion restoration or image
          generation fill with ai.
        </p>
      </div>
